	soc_system u0 (
		...
		.fifo_pls_in_writedata                 (<connected-to-fifo_pls_in_writedata>),                 //                 fifo_pls_in.writedata
		.fifo_pls_in_write                     (<connected-to-fifo_pls_in_write>),                     //                            .write
		...
		.pulse_counter_conduit_inout_wirtedata (<connected-to-pulse_counter_conduit_inout_wirtedata>), // pulse_counter_conduit_inout.wirtedata
		.pulse_counter_conduit_inout_write     (<connected-to-pulse_counter_conduit_inout_write>),     //                            .write
		.pulse_counter_conduit_inout_photon    (<connected-to-pulse_counter_conduit_inout_photon>),    //                            .photon
		.pulse_counter_conduit_inout_tri_in    (<connected-to-pulse_counter_conduit_inout_tri_in>),    //                            .tri_in
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                       reset.reset_n
		.trigger_conduit_trigger_trigger       (<connected-to-trigger_conduit_trigger_trigger>),       //     trigger_conduit_trigger.trigger
		.trigger_sim_conduit_trigger_trigger   (<connected-to-trigger_sim_conduit_trigger_trigger>)    // trigger_sim_conduit_trigger.trigger
	);
